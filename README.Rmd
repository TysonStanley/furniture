...
Alternatively, `table1_flextable()` integrates the `flextable` package for flexible and customizable table output (especially useful for Word documents).
