...
table1(.data, ..., splitby, row_wise, test, output_type, format_output, format_number, NAkeep, splitby_labels, var_names, simple, condense)
```
...
7. Table has multiple formatting options to fit various needs using `output_type`, `format_output`, `simple` and `condense`.
